    ...
    override func viewDidLoad() {
        ...
        for (index, imageView) in imageViews.enumerated() {
            ...
            case 2:
                ...
                galleryItem = GalleryItem.video(fetchPreviewImageBlock: { $0(UIImage(named: "2")!, nil) }, videoURL: URL (string: "http://video.dailymail.co.uk/video/mol/test/2016/09/21/5739239377694275356/1024x576_MP4_5739239377694275356.mp4")!)

            case 4:

                let myFetchImageBlock: FetchImageBlock = { $0(imageView.image!, nil) }
            ...
            default:
                ...
                galleryItem = GalleryItem.image { $0(image, nil) }
            }
